...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader shader1 = new BitmapShader(BitmapFactory.decodeResource(getContext().getResources(), R.drawable.batman), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shader2 = new BitmapShader(BitmapFactory.decodeResource(getContext().getResources(), R.drawable.batman_logo), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
